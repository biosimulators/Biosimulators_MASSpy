...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulators_masspy')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulators/Biosimulators_MASSpy/blob/dev/'
project = 'BioSimulators-MASSpy'
...
html_theme_options = {
    ...
    'github_repo': 'Biosimulators_MASSpy',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to MASSpy',
    'fixed_sidebar': True,
    ...
    'extra_nav_links': {
        ...
        'MASSpy': 'https://masspy.readthedocs.io/',
    }
}
